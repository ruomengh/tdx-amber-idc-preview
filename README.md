...
### 3.4 Use Trust Authority client to generate quote
...
```
_NOTE: The response forst is like `Trace Id: <TraceID>=<token>`. Please copy the token part as input of the next step._
